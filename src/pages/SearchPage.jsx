    ...
    return (
        <div className="flex flex-col gap-12 lg:flex-row">
            ...
            <div className="flex-1">
                ...
                {loading ? (
                    <div className="text-center py-24 text-brand-gray">Searching...</div>
                ) : error ? (
                    ...
                    <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-brand-light py-24 text-center">
                        ...
                        <button
                            onClick={() => {
                                setFilters({ minPrice: '', maxPrice: '', brands: [], rating: null })
                                // Optionally clear search query via navigation if desired, but clearing filters is usually enough
                            }}
